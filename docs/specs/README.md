...
| Document | Description | Chinese |
| --- | --- | --- |
| [00 Overview](00-overview.md) | Scope, goals, document set, and normative language | [中文](00-overview.zh-CN.md) |
| [01 Envelope](01-envelope.md) | Envelope model, top-level fields, `tx`, `auth`, and QR transport | [中文](01-envelope.zh-CN.md) |
| [02 Trust Model](02-trust-model.md) | Vendor roots, QR signing certificates, signatures, and publication roles | [中文](02-trust-model.zh-CN.md) |
...
| 文档 | 说明 | English |
| --- | --- | --- |
| [00 概览](00-overview.zh-CN.md) | 范围、目标、文档集合和规范用语 | [English](00-overview.md) |
| [01 Envelope](01-envelope.zh-CN.md) | Envelope 模型、顶层字段、`tx`、`auth` 和 QR 传输 | [English](01-envelope.md) |
| [02 信任模型](02-trust-model.zh-CN.md) | 厂商根、QR 签名证书、签名和发布角色 | [English](02-trust-model.md) |
